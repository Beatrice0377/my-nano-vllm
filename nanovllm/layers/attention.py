...
class Attention(nn.Module):
    ...
    def forward(self, q: torch.Tensor, k: torch.Tensor, v: torch.Tensor):
        ...
        if num_decode == 0:  # pure prefill
        ...
        elif num_decode == q.size(0):  # pure decode
        ...
        else:  # mixed: decode rows first, then prefill rows
            ...
            if context.prefill_block_tables is not None:  # prefix cache
                ...
                k_p, v_p = k[num_decode:], v[num_decode:]
            ...
            o = torch.cat([o_d.squeeze(1), o_p], dim=0)
        return o
